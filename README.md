# find-a-flikr-react-app 
Built an image gallery using React and the Flickr API. This was project 11 of the 12 projects required for completing the Treehouse Front End Web Development Techd-egree program. 
## Some skills that were showcased here are:
 - Ability to Bootstrap a create-react-app.
 - Ability to build components from a mockup and exceed clients build expectations
 - Integrate CSS 
 - Set up routing 
 - Handle URL routing 
 - Modular code design
